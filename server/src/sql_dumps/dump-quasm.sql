...
-- Started on 2024-04-13 17:11:17
...
CREATE TABLE public."Characters" (
    ...
    "submitTimestamp" timestamp without time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public."Rooms" (
    id character varying(36) NOT NULL,
    "gameMasterID" character varying(36) NOT NULL,
...
--
-- TOC entry 3221 (class 2604 OID 16662)
...
--
-- TOC entry 3218 (class 2604 OID 16634)
...
--
-- TOC entry 3228 (class 2606 OID 16652)
...
--
-- TOC entry 3230 (class 2606 OID 16667)
...
--
-- TOC entry 3226 (class 2606 OID 16639)
...
--
-- TOC entry 3232 (class 2606 OID 16653)
...
--
-- TOC entry 3233 (class 2606 OID 16668)
-- Name: ChatMessages ChatMessages_from_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ChatMessages"
    ADD CONSTRAINT "ChatMessages_from_fkey" FOREIGN KEY ("from") REFERENCES public."Characters"(id);


--
-- TOC entry 3234 (class 2606 OID 16673)
-- Name: ChatMessages ChatMessages_to_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ChatMessages"
    ADD CONSTRAINT "ChatMessages_to_fkey" FOREIGN KEY ("to") REFERENCES public."Characters"(id);


--
-- TOC entry 3231 (class 2606 OID 16640)
...
-- Completed on 2024-04-13 17:11:38
